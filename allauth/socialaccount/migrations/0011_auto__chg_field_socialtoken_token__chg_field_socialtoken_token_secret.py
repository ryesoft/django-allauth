...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'socialaccount_socialtoken', 'token', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'SocialToken.token'
        db.alter_column(u'socialaccount_socialtoken', 'token', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 11, 17, 11, 29, 717543)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 4, 11, 17, 11, 29, 716671)'}),
